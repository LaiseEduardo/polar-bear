...
describe('RequestHelperService', () => {
  ...
  it('should send get request', () => {
    service.get('testUrl');
    expect(spyHttpClient.get).toHaveBeenCalledOnceWith(
      apiTestUrl,
  ...
  it('should send post request', () => {
    ...
    expect(spyHttpClient.post).toHaveBeenCalledOnceWith(
      apiTestUrl,
      {},
      jasmine.objectContaining({ headers: jasmine.any(Object) })
    );
  ...
  it('should send put request', () => {
    service.put('testUrl', {});
    expect(spyHttpClient.put).toHaveBeenCalledOnceWith(
      apiTestUrl,
      {},
      jasmine.objectContaining({ headers: jasmine.any(Object) })
    );
  ...
  it('should send delete request', () => {
    ...
    expect(spyHttpClient.delete).toHaveBeenCalledOnceWith(
      apiTestUrl,
      jasmine.objectContaining({ headers: jasmine.any(Object) })
    );
  });
