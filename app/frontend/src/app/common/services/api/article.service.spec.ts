...
describe('ArticleService', () => {
  ...
  it('should update article', () => {
    ...
    expect(spyRequestHelperService.put).toHaveBeenCalledWith(
      `/articles/${expectedSlug}`,
      expectedPayload
    );
  });
  ...
  it('should query articles', () => {
    ...
    expect(spyRequestHelperService.get).toHaveBeenCalledWith('/articles', {
  ...
  it('should query feed articles', () => {
    ...
    expect(spyRequestHelperService.get).toHaveBeenCalledWith('/articles/feed', {
      params: expectedParams,
    });
  });
  ...
  it('should favorite article', () => {
    ...
    expect(spyRequestHelperService.post).toHaveBeenCalledWith(
      `/articles/${expectedSlug}/favorite`,
      null
    );
  });
  ...
  it('should unfavorite article', () => {
    ...
    expect(spyRequestHelperService.delete).toHaveBeenCalledWith(
      `/articles/${expectedSlug}/favorite`
    );
  });
  ...
  it('should create article comment', () => {
    ...
    expect(spyRequestHelperService.post).toHaveBeenCalledWith(
      `/articles/${expectedSlug}/comments`,
      expectedPayload
    );
  });
  ...
  it('should delete article comment', () => {
    ...
    expect(spyRequestHelperService.delete).toHaveBeenCalledWith(
      `/articles/${expectedSlug}/comments/${expectedCommentId}`
    );
  });
});
