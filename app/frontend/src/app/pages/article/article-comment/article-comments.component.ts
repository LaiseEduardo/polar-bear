...
export class ArticleCommentsComponent {
  ...
  private _loadComments(): void {
    this._articleService.queryArticleComments(this._articleSlug).subscribe((response) => {
  ...
  public deleteComment(commentId: number): void {
    this._articleService.deleteArticleComment(this._articleSlug, commentId).subscribe(() => {
  ...
  public addComment(): void {
    ...
    this._articleService.createArticleComment(this._articleSlug, payload).subscribe((response) => {
