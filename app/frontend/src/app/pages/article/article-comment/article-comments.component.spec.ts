...
describe('ArticleCommentsComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [
        RouterModule.forRoot([{ path: 'article/1', component: ArticleCommentsComponent }]),
        ArticleCommentsComponent,
      ],
      providers: [AuthenticationService, { provide: ArticleService, useValue: spyArticleService }],
    })
